...
function buildSystemPrompt(clientName, channel, nivelInfo) {
  ...
  const nivelMsg   = nivelLabel ? '- Este cliente tiene nivel ' + nivelLabel + '. Los precios ya incluyen su descuento.\n' : '';
  return 'Eres asesor de ' + CATALOG.negocio.nombre + ' (' + CATALOG.negocio.ciudad + '). Canal: ' + channel + '.\n'
    ...
    + '- ' + formato + '\n'
    + nivelMsg
    + '- Cada precio es por pieza/presentación completa, NO por litro ni kg\n'
